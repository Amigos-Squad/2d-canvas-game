...
export const TopicItem = (): ReactElement => (
    <div className="topic-item">
        <div className="topic-item__statusIcon"><TopicOpenIcon/></div>
        <div className="topic-item__title">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque</div>
